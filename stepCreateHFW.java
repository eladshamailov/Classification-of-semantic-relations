...
public class stepCreateHFW {

	private static class Map extends Mapper<LongWritable, Text, Text, Text> {
		public static Long c0=new  Long(0);
		private static final Double fh=10.0;
		@Override
	...
	public static void main(String[] args) throws Exception, ClassNotFoundException, InterruptedException  {
		...
		job.setJarByClass(stepCreateHFW.class);
		job.setMapperClass(Map.class);
		job.setCombinerClass(Reduce.class);
		job.setReducerClass(Reduce.class);
		job.setOutputKeyClass(Text.class);
		job.setOutputValueClass(Text.class);
		job.setPartitionerClass(stepCreateHFW.PartitionerClass.class);
